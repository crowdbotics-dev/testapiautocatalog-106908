...
## Project Structure
    ...
    ├── testapiautocatalog_106908  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_106908`
...
2. Clone this repo and `cd testapiautocatalog_106908`
